  ...
  expressions: {
    list: [
      ...
      { type: 'folder', id: '79', title: 'Barbell 1', collapsed: true },
      {
        ...
        folderId: '79',
        color: 'black',
        latex: 'b_{arbellCtrlPt1}=\\left(b_{arbellCtrlPt4X},0\\right)',
        dragMode: 'X',
      },
      {
        type: 'expression',
      ...
      },
      {
        ...
        folderId: '79',
        color: 'black',
        latex: 'b_{arbellTopPt1}=\\left(b_{arbellCtrlPt4X},t_{opLineY}\\right)',
        dragMode: 'NONE',
      },
      {
        type: 'expression',
        ...
        folderId: '79',
        color: 'black',
        latex: 'b_{arbellBotPt1}=\\left(b_{arbellCtrlPt4X},b_{otLineY}\\right)',
        dragMode: 'NONE',
      },
      {
        type: 'expression',
        ...
        color: 'black',
        latex:
          'b_{arbellLine1}=b_{arbellCtrlPt4X}\\left\\{b_{otLineY}<y<t_{opLineY}\\right\\}',
        lineStyle: 'DASHED',
      },
      {
        type: 'expression',
...
Object.assign(barbellInput4.style, inputStyle);
Object.assign(barbellInput2.style, inputStyle);
Object.assign(barbellInput3.style, inputStyle);

elt.append(barbellInput4);
elt.append(barbellInput2);
elt.append(barbellInput3);

const barbell4X = calculator.HelperExpression({ latex: 'b_{arbellCtrlPt4X}' });
barbell4X.observe('numericValue', () => {
  const x = Math.round(
    calculator.mathToPixels({ x: barbell4X.numericValue }).x
  );

  if (
    barbell4X.numericValue != 0 &&
    (isWithin(x, parseInt(barbellInput2.style.left), 50) ||
      isWithin(x, parseInt(barbellInput3.style.left), 50))
  ) {
    barbellInput4.style.top = '375px';
  } else {
    barbellInput4.style.top = '325px';
  }
  barbellInput4.style.left = `${x}px`;
});
...
barbell2X.observe('numericValue', () => {
  ...
  if (
    barbell2X.numericValue != 0 &&
    (isWithin(x, parseInt(barbellInput4.style.left), 50) ||
      isWithin(x, parseInt(barbellInput3.style.left), 50))
  ) {
    barbellInput2.style.top = '375px';
  } else {
    barbellInput2.style.top = '325px';
  }
  barbellInput2.style.left = `${x}px`;
});
...
barbell3X.observe('numericValue', () => {
  ...
  if (
    barbell3X.numericValue != 0 &&
    (isWithin(x, parseInt(barbellInput4.style.left), 50) ||
      isWithin(x, parseInt(barbellInput2.style.left), 50))
  ) {
    barbellInput3.style.top = '375px';
  } else {
    barbellInput3.style.top = '325px';
  }
  barbellInput3.style.left = `${x}px`;
});
