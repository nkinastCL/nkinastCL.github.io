...
const state = {
  ...
  graph: {
    viewport: { xmin: -4, ymin: -12, xmax: 16.8, ymax: 12 },
    showGrid: false,
    showXAxis: false,
    showYAxis: false,
    xAxisNumbers: false,
  ...
  expressions: {
    list: [
      { type: "folder", id: "87", title: "Customization" },
      {
        type: "text",
        id: "89",
        folderId: "87",
        text: "Adjust the number of tick marks here.",
      },
      {
        type: "expression",
        id: "13",
      ...
      },
      {
        ...
        id: "91",
        folderId: "87",
        text: "Adjust the distance between tick marks on the top line here.",
      },
      {
        type: "expression",
        id: "55",
      ...
      },
      {
        ...
        id: "92",
        folderId: "87",
        text: "Adjust the distance between tick marks on the bottom line here.",
      },
      {
        type: "expression",
        id: "56",
      ...
      },
      {
        ...
        id: "93",
        folderId: "87",
        text: 'Change the label for the top line by updating the "Label" field here.',
      },
      {
        type: "expression",
        id: "48",
      ...
      },
      {
        ...
        id: "94",
        folderId: "87",
        text: 'Change the label for the bottom line by updating the "Label" field here.',
      },
      {
        type: "expression",
        id: "50",
